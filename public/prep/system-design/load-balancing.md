...
│   │   (Round Robin / Weighted)  │  ← SSL Termination            │
│   └──────────────┬──────────────┘                               │
│                  │                                              │
│       ┌──────────┼──────────┐                                   │
│       │          │          │                                   │
│       ▼          ▼          ▼                                   │
│   ┌───────┐  ┌───────┐  ┌───────┐                               │
│   │ Web 1 │  │ Web 2 │  │ Web 3 │  ← Identical Servers          │
│   └───────┘  └───────┘  └───────┘                               │
│                                                                 │
│   Algorithms:                                                   │
│   • Round Robin: Cycles through servers 1→2→3→1→2→3            │
│   • Least Conn: Routes to server with fewest connections        │
